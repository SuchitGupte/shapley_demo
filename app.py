...
with tab_framework:
    ...
    with tab_1:
        ...
        We systematically evaluate 8 distinct replacement strategies and 16 distinct approximation algorithms across a diverse set of 100 datasets. 
